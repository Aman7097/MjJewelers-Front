...
export const getProducts = (keyword = ' ', currentPage = 1, price, category, rating = 0) => async (dispatch) => {
    try {
        ...
        let link = `https://mjjewelers.herokuapp.com/api/v1/products?keyword=${keyword}&page=${currentPage}
                    &price[lte]=${price[1]}&price[gte]=${price[0]}&ratings[gte]=${rating}`


        if (category) {
            link =
                `https://mjjewelers.herokuapp.com/api/v1/products?keyword=${keyword}&page=${currentPage}'
